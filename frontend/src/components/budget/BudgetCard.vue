  ...
  <div
    ...
    <div class="mt-4 flex items-baseline justify-between text-sm">
      <div>
        ...
        <span class="font-bold text-base" :class="budget.spent > budget.amount ? 'text-error' : 'text-base-content'">
      ...
      <div class="text-right">
        <span v-if="budget.spent > budget.amount" class="inline-flex items-center gap-1 text-base font-bold text-error">
