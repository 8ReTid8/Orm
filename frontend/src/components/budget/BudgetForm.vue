    ...
    <dialog ref="dialogRef" class="modal">
        <div class="modal-box max-w-lg ">
            ...
            <Form class="mt-6 space-y-4 " @submit.prevent="submitForm">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <fieldset class="fieldset gap-0.5">
                        <label class="label text-base">วันที่เริ่มต้น</label>
                        <input v-model="form.startDate" type="date" class="input w-full" required />
                    </fieldset>

                    <fieldset class="fieldset gap-0.5">
                        <label class="label text-base">วันที่สิ้นสุด</label>
                        <input v-model="form.endDate" type="date" class="input w-full" required />
                    </fieldset>
                </div>
